...
How to add, edit, and use string resources in the Compose Multiplatform project and screenshot tests.
...
**File Path:** `compose-resources/src/commonMain/composeResources/values/strings.xml`
