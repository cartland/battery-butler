...
import com.chriscartland.batterybutler.server.HelloRequest
import com.chriscartland.batterybutler.server.GreeterClient

@RunWith(AndroidJUnit4::class)
class RemoteConnectivityTest {

    @Test
    fun testProductionServerConnectivity() = runBlocking {
