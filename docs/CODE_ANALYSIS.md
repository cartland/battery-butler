...
Total Lines of Code: 34969

## Application Breakdown
* Shared Code: 24,592 lines (70.3%)
* Other: 2,917 lines (8.3%)
* iOS Swift App: 2,780 lines (7.9%)
* CMP Android, iOS, Desktop: 2,169 lines (6.2%)
* Server: 1,528 lines (4.4%)
* Android Screenshot Tests: 983 lines (2.8%)

## Module Breakdown
* `:presentation-feature`: 5,730 lines (16.4%)
* `:viewmodel`: 4,566 lines (13.1%)
* `:usecase`: 4,073 lines (11.6%)
* `:iosAppSwiftUI.xcodeproj`: 2,780 lines (7.9%)
* `:data-network`: 2,412 lines (6.9%)
* `:domain`: 2,293 lines (6.6%)
* `:compose-app`: 2,169 lines (6.2%)
* `:presentation-core`: 2,095 lines (6.0%)
* `:data`: 1,801 lines (5.2%)
* `:buildSrc`: 1,353 lines (3.9%)
