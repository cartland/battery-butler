...
Total Lines of Code: 49788

## Application Breakdown
* Shared Code: 33,510 lines (67.3%)
* iOS Swift App: 5,631 lines (11.3%)
* Other: 5,225 lines (10.5%)
* CMP Android, iOS, Desktop: 2,679 lines (5.4%)
* Server: 1,530 lines (3.1%)
* Android Screenshot Tests: 1,213 lines (2.4%)

## Module Breakdown
* `:presentation-feature`: 6,748 lines (13.6%)
* `:viewmodel`: 6,047 lines (12.1%)
* `:iosAppSwiftUI.xcodeproj`: 5,631 lines (11.3%)
* `:usecase`: 5,404 lines (10.9%)
* `:data-network`: 4,087 lines (8.2%)
* `:buildSrc`: 2,810 lines (5.6%)
* `:presentation-core`: 2,584 lines (5.2%)
* `:domain`: 2,582 lines (5.2%)
* `:compose-app`: 2,412 lines (4.8%)
* `:data`: 2,115 lines (4.2%)
* `:data-local`: 1,699 lines (3.4%)
* `:server:app`: 1,344 lines (2.7%)
* `:android-screenshot-tests`: 1,213 lines (2.4%)
* `:test-common`: 721 lines (1.4%)
* `:ai`: 505 lines (1.0%)
...
## Language Breakdown
* Kotlin (.kt): 43,891 lines (88.2%)
* Swift (.swift): 5,897 lines (11.8%)
...
Codebase,Shared Code,33510
Codebase,iOS Swift App,5631
Codebase,Other,5225
Codebase,CMP Apps,2679
Codebase,Server,1530
Codebase,Screenshot Tests,1213

Shared Code,presentation-feature,6748
Shared Code,viewmodel,6047
Shared Code,usecase,5404
Shared Code,data-network,4087
Shared Code,presentation-core,2584
Shared Code,domain,2582
Shared Code,data,2115
