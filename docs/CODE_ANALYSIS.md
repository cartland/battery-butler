...
Total Lines of Code: 46780

## Application Breakdown
* Shared Code: 30,005 lines (64.1%)
* iOS Swift App: 6,302 lines (13.5%)
* Other: 5,146 lines (11.0%)
* CMP Android, iOS, Desktop: 2,586 lines (5.5%)
* Server: 1,528 lines (3.3%)
* Android Screenshot Tests: 1,213 lines (2.6%)

## Module Breakdown
* `:presentation-feature`: 6,456 lines (13.8%)
* `:iosAppSwiftUI.xcodeproj`: 6,302 lines (13.5%)
* `:usecase`: 5,405 lines (11.6%)
* `:viewmodel`: 5,366 lines (11.5%)
* `:buildSrc`: 2,811 lines (6.0%)
* `:presentation-core`: 2,524 lines (5.4%)
* `:data-network`: 2,452 lines (5.2%)
* `:domain`: 2,332 lines (5.0%)
* `:compose-app`: 2,319 lines (5.0%)
* `:data`: 1,920 lines (4.1%)
* `:server:app`: 1,342 lines (2.9%)
...
## Language Breakdown
* Kotlin (.kt): 40,212 lines (86.0%)
* Swift (.swift): 6,568 lines (14.0%)
...
Codebase,Shared Code,30005
Codebase,iOS Swift App,6302
Codebase,Other,5146
Codebase,CMP Apps,2586
Codebase,Server,1528
Codebase,Screenshot Tests,1213

Shared Code,presentation-feature,6456
Shared Code,usecase,5405
Shared Code,viewmodel,5366
Shared Code,presentation-core,2524
...
iOS Swift App,iosAppSwiftUI,6302
...
presentation-feature,Kotlin,6456
iosAppSwiftUI,Swift,6302
usecase,Kotlin,5405
viewmodel,Kotlin,5366
buildSrc,Kotlin,2811
presentation-core,Kotlin,2524
data-network,Kotlin,2452
domain,Kotlin,2332
compose-app,Kotlin,2319
data,Kotlin,1920
