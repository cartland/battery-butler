...
* `:domain`: 2,193 lines (8.0%)
* `:presentation-core`: 1,767 lines (6.4%)
* `:data`: 1,752 lines (6.4%)
* `:compose-app`: 1,720 lines (6.3%)
* `:server:app`: 1,347 lines (4.9%)
* `:data-local`: 1,050 lines (3.8%)
* `:iosAppSwiftUI.xcodeproj`: 1,028 lines (3.7%)
