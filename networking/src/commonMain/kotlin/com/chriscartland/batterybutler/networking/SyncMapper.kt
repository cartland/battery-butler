...
internal object SyncMapper {
    ...
    private fun DeviceType.toProto(): ProtoDeviceType = ProtoDeviceType(
        id = id,
        name = name
    )
    ...
    private fun Device.toProto(): ProtoDevice = ProtoDevice(
        id = id,
        name = name,
        type_id = typeId,
        location = location ?: ""
    ...
    private fun BatteryEvent.toProto(): ProtoBatteryEvent = ProtoBatteryEvent(
        id = id,
        device_id = deviceId,
