...
internal object ServerSyncMapper {
    ...
    private fun ProtoDeviceType.toDomain(): DeviceType = DeviceType(
        id = id,
        name = name
    )

    private fun DeviceType.toProto(): ProtoDeviceType = ProtoDeviceType.newBuilder()
        .setId(id)
        .setName(name)
        .build()

    private fun ProtoDevice.toDomain(): Device = Device(
        id = id,
        name = name,
        typeId = typeId,
    ...
    private fun Device.toProto(): ProtoDevice = ProtoDevice.newBuilder()
        .setId(id)
        .setName(name)
        .setTypeId(typeId)
    ...
    private fun ProtoBatteryEvent.toDomain(): BatteryEvent = BatteryEvent(
        id = id,
        deviceId = deviceId,
    ...
    private fun BatteryEvent.toProto(): ProtoBatteryEvent = ProtoBatteryEvent.newBuilder()
        .setId(id)
