...
object DeviceIconMapper {
    ...
    fun getIcon(iconName: String?): ImageVector =
        when (iconName) {
            ...
            "detector_smoke" -> Icons.Default.Propane // Closest match
    ...
    fun getContainerColor(iconName: String?): Color =
        when (iconName) {
            ...
            "garage_home", "settings_remote" -> Color(0xFFF1F5F9) // slate-100
            ...
            "straighten", "scale" -> Color(0xFFF3F4F6) // gray-100
    ...
    fun getContentColor(iconName: String?): Color =
        when (iconName) {
            "videogame_asset", "toys" -> Color(0xFF0284C7) // sky-600
            "tv", "mouse", "keyboard" -> Color(0xFF475569) // slate-600
            ...
            "garage_home", "settings_remote" -> Color(0xFF475569) // slate-600
            ...
            "straighten", "scale" -> Color(0xFF4B5563) // gray-600
